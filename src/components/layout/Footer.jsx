  ...
  return (
    <footer className="border-t border-border bg-muted/30">
      <div className="mx-auto max-w-5xl px-4 sm:px-6">
        <div className="hidden gap-10 py-12 md:grid md:grid-cols-2 lg:grid-cols-[1.4fr_0.8fr_1fr] lg:gap-12">
          ...
          <div className="space-y-4">
            ...
            <p className="max-w-sm text-sm leading-relaxed text-muted-foreground">
              Um espaço para compartilhar meus projetos,
              minha trajetória e o que estou construindo.
            </p>
          </div>
          ...
          <div className="space-y-4 md:col-span-2 lg:col-span-1">
            ...
            <p className="max-w-sm text-sm leading-relaxed text-muted-foreground">
              Tem uma ideia ou quer saber mais sobre meu trabalho?
              Entre em contato.
            </p>
        ...
        {/* Faixa inferior */}
        <div className="flex flex-col gap-2 border-t border-border py-6 text-xs leading-relaxed text-muted-foreground sm:flex-row sm:items-center sm:justify-between">
